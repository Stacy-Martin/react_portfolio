        ...
        <div className="section headerText">
          <div className="row">
            ...
            <div className="col l8 m8 s12">
              <h6 className="flow-text" id="myName">
                Stacy Martin
              </h6>
            </div>
          </div>
          <h7 className="flow-text" id="basics">
            I am a US and Belize based, full-stack software developer eager to
            help small businesses and non-profits digitize their platform.
          </h7>
        </div>
      </section>
    </div>
